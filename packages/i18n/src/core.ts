/**
 * Pure i18n primitives. No runtime deps — safe to import from any environment
 * (Next server/client, Tauri, Node scripts, tests).
 */

export const LOCALES = [
  "en", "fr", "es", "de", "pt", "ja", "it", "nl",
  "ko", "zh", "ru", "tr", "pl", "ar", "hi", "sv",
] as const
